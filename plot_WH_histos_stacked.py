...
name_of_bg_file = [
		    "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_ZPlusJets_SusySel.root", 
		    "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_ttbar_SusySel.root",
		    "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WZ_SusySel.root",
		    "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_ZZ_SusySel.root",  
		    "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WW_SusySel.root", 
		    "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WWPlusJets_SusySel.root", 
		    "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_Higgs_SusySel.root",
		    "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_fake_SusySel.root"
		    ]

file_cutflow_126893 = "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_126893_SusySel.root"
		
name_of_signal_file = [
		       "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177501_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177502_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177503_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177504_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177505_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177506_SusySel.root", 
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177507_SusySel.root",
		       "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177508_SusySel.root", 
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177509_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177510_SusySel.root", 
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177511_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177512_SusySel.root", 
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177513_SusySel.root", 
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177514_SusySel.root", 
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177515_SusySel.root",
		       "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177516_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177517_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177518_SusySel.root",
		       "/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177519_SusySel.root"
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177520_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177521_SusySel.root", 
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177522_SusySel.root", 
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177523_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177524_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177525_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177526_SusySel.root",
		       #"/data/etp3/jwittkow/analysis_SUSYTools_03_04/output_WH_177527_SusySel.root"
		       ]
...
name_of_variables = ["mT2J","pTl0", "pTl1", "HT", "mll", "METrel", "mWWt", "mljj",  "mTlmax", "mTlmin", "DeltaEtall", "mlj"
]
...
x_axis_title = ["mT2J", "pTl0", "pTl1", "HT", "mll", "METrel", "mWWt", "mljj", "mTlmax", "mTlmin", "DeltaEtall", "mlj"
...
name_of_SR = ["1j_MM"]#, "EE_SRSS2"]#, "MM_SRSS1", "MM_SRSS2", "MM_SRSS3", "MM_SRSS4", "EM_SRSS1", "EM_SRSS2", "EE_SROS1", "MM_SROS1", "EM_SROS1"]
...
if print_numbers_contributions:
  ...
  print '{\\tiny bg contribution} & {\\tiny EE 1j} & {\\tiny MM 1j} & {\\tiny EM 1j} & {\\tiny EE 2j} & {\\tiny MM 2j} & {\\tiny EM 2j}\\\\'
  #print '  & {\\tiny $E_{T}^{miss,rel}$ cut, 3rd lep veto} & {\\tiny $H_{T}$ cut, 3rd lep veto} & {\\tiny $E_{T}^{miss,rel}$ cut, 3rd lep veto} & {\\tiny $E_{T}^{miss,rel}$ cut, 3rd lep veto} & {\\tiny $H_{T}$ cut, 3rd lep veto} & {\\tiny $E_{T}^{miss,rel}$ cut, 3rd lep veto}\\\\ '
  #print '  & {\\tiny $E_{T}^{miss,rel} cut, 3rd lep veto} & {\\tiny $H_{T}cut, 3rd lep veto} & {\\tiny E_{T}^{miss,rel} cut, 3rd lep veto}\\\\ '
  print "\hline  "
  sum_EE_1j = 0
  sum_MM_1j = 0
  sum_EM_1j = 0
  ...
  for i_rf, rf in enumerate(rootfiles_cutflow):  
    ...
    bg_histo_projected_EE = bg_histo_EE#.ProjectionX("cutflow_EE_ALL" + name_of_contribution[i_rf], 7, 7)
    nbins = bg_histo_projected_EE.GetNbinsX()
    bg_histo_MM = rf.Get("cutflow_MM_ALL")	
    bg_histo_projected_MM = bg_histo_MM#.ProjectionX("cutflow_MM_ALL" + name_of_contribution[i_rf], 2, 2)
    ...
    if name_of_contributionLegend[i_rf]!= "126893":
      sum_EE_1j = sum_EE_1j + bg_histo_projected_EE.Integral(38, 38)
      sum_MM_1j = sum_MM_1j + bg_histo_projected_MM.Integral(38, 38)
      sum_EM_1j = sum_EM_1j + bg_histo_projected_EM.Integral(38, 38)
      sum_EE_2j = sum_EE_2j + bg_histo_projected_EE.Integral(57, 57)
      sum_MM_2j = sum_MM_2j + bg_histo_projected_MM.Integral(58, 58)
      sum_EM_2j = sum_EM_2j + bg_histo_projected_EM.Integral(56, 56)
    #sum_total = sum_total + bg_histo_total.GetBinContent( 1)
    print '{\\tiny ', name_of_contributionLegend[i_rf], ":} & {\\tiny ",round(bg_histo_projected_EE.Integral(38, 38),2), "} & {\\tiny ", round(bg_histo_projected_MM.Integral(38, 38),2), "} & {\\tiny ",round(bg_histo_projected_EM.Integral(38, 38),2), "} & {\\tiny ",round(bg_histo_projected_EE.Integral(57, 57),2), "} & {\\tiny ", round(bg_histo_projected_MM.Integral(58, 58),2), "} & {\\tiny ",round(bg_histo_projected_EM.Integral(56, 56),2), "}\\\\"
  print "\hline"  
  print "\hline"  
  print "{\\tiny Total} &  {\\tiny ", round(sum_EE_1j,2),  "} & {\\tiny", round(sum_MM_1j,2),  "} & {\\tiny", round(sum_EM_1j,2),  "} &  {\\tiny ", round(sum_EE_2j,2),  "} & {\\tiny", round(sum_MM_2j,2),  "} & {\\tiny", round(sum_EM_2j,2),  "} \\\\"

  print '{\\tiny signal} & {\\tiny EE 1j} & {\\tiny MM 1j} & {\\tiny EM 1j} & {\\tiny EE 2j} & {\\tiny MM 2j} & {\\tiny EM 2j}\\\\'
  print "\hline  "
  for i_g, rf in enumerate(rootfiles_gridpoints):  
    ...
    #bg_histo_total = rf.Get("cutflow_EM_ALL")	
    print "{\\tiny ", mcid_of_grid_point[i_g], ":} & {\\tiny ",round(bg_histo_projected_EE.Integral(38, 38),2), "} & {\\tiny ", round(bg_histo_projected_MM.Integral(38, 38),2), "} & {\\tiny",round(bg_histo_projected_EM.Integral(38, 38),2), "} & {\\tiny ",round(bg_histo_projected_EE.Integral(57, 57),2), "} & {\\tiny ", round(bg_histo_projected_MM.Integral(58, 58),2), "} & {\\tiny",round(bg_histo_projected_EM.Integral(56, 56),2), "}\\\\"
...
for i_v, v in enumerate(name_of_variables):
  ...
  for i_s, s in enumerate(name_of_SR):
	...
	pad2.cd().Update()
	#end draw_pad2      
      c1.SaveAs("/data/etp/jwittkowski/pics_reoptimization/cumulative_pdf_" + v + "_" + s + "_" + mcid_of_grid_point[i_g] + "_bin" + str(ybinProj_list[i_s]) + ".pdf")
