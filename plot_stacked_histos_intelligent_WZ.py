...
name_of_bg_file = [
		    ...
		    #"/data/etp/jwittkowski/outputfiles/histos_ZN_Higgs_ORcategory.root",
		    #"/data/etp/jwittkowski/outputfiles/histos_ZN_fakebg_ORcategory.root"
		    ]
		
name_of_signal_file = [
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177501_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177502_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177503_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177504_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177505_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177506_ORcategory.root", 
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177507_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177508_ORcategory.root", 
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177509_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177510_ORcategory.root", 
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177511_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177512_ORcategory.root", 
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177513_ORcategory.root", 
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177514_ORcategory.root", 
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177515_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177516_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177517_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177518_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177519_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177520_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177521_ORcategory.root", 
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177522_ORcategory.root", 
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177523_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177524_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177525_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177526_ORcategory.root",
		       #"/data/etp/jwittkowski/outputfiles/histos_ZN_177527_ORcategory.root"
		       ]

name_of_contributionLegend = ["WZ", "ZZ", "WW", "WW+Jets", "Higgs", "fake"]		
fillColors = [ ROOT.kSpring+1, ROOT.kGreen+3, ROOT.kBlue-2, ROOT.kAzure+8, ROOT.kYellow, ROOT.kGray+1]
name_of_contribution = ["WZ", "ZZ", "WW", "WWPlusJets", "Higgs", "fake"]

name_of_variables = ["Nleptons_lost", "ml0loverlap", "ml1loverlap", "mTl0loverlap", "mTl1loverlap", "ml0loverlapWJet", "ml1loverlapWJet", "mTl0loverlapWJet", "mTl1loverlapWJet", "ml0loverlapWOFLepton", "ml1loverlapWOFLepton", "mTl0loverlapWOFLepton", "mTl1loverlapWOFLepton", "ml0loverlapWSFLepton", "ml1loverlapWSFLepton", "mTl0loverlapWSFLepton", "mTl1loverlapWSFLepton", "ml0lZcand", "ml1lZcand", "mTl0lZcand", "mTl1lZcand"
]
...
x_axis_title = ["Nleptons_lost", "ml0loverlap", "ml1loverlap", "mTl0loverlap", "mTl1loverlap", "ml0loverlapWJet", "ml1loverlapWJet", "mTl0loverlapWJet", "mTl1loverlapWJet", "ml0loverlapWOFLepton", "ml1loverlapWOFLepton", "mTl0loverlapWOFLepton", "mTl1loverlapWOFLepton", "ml0loverlapWSFLepton", "ml1loverlapWSFLepton", "mTl0loverlapWSFLepton", "mTl1loverlapWSFLepton", "ml0lZcand", "ml1lZcand", "mTl0lZcand", "mTl1lZcand"
]
...
for i_v, v in enumerate(name_of_variables):
  ...
  for i_s, s in enumerate(name_of_SR):
    ...
    c1 = ROOT.TCanvas("c_" + v + "_" + s + "_", "c_" + v + "_" + s + "_" , 600, 600)
    c1.SetLogy()
	...
	if max(cut_efficiency_bg, cut_efficiency_s) > eff_max:
      ...
      pad2.cd().Update()
	#end draw_pad2      
    c1.SaveAs("/data/etp/jwittkowski/pics/cumulative_pdf_" + v + "_" + s + "_bin" + str(ybinProj_list[i_s]) + "_WZ_woJOR.pdf")
