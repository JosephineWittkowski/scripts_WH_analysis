...
name_of_bg_file = [
		    ...
		    "/data/etp3/jwittkow/analysis_SUSYTools_03_04/outputfiles/histos_ZN_WW_softLeptonCheck.root", 
...
name_of_signal_file = [
		       "/data/etp3/jwittkow/analysis_SUSYTools_03_04/outputfiles/histos_ZN_177501_softLeptonCheck.root",
...
name_of_variables = ["ml0lsoft", "ml1lsoft", "mTl0lsoft", "mTl1lsoft", "Mljj"]
...
for i_g, grid_point_file in enumerate(rootfiles_gridpoints):
  ...
  for i_v, v in enumerate(name_of_variables):
	...
	if max(cut_efficiency_bg, cut_efficiency_s) > eff_max:
      ...
      pad2.cd().Update()
      c1.SaveAs("/data/etp/jwittkowski/pics/cumulative_pdf_" + v + "_" + s + "_" + mcid_of_grid_point[i_g] + "_bin" + str(ybinProj_list[i_s]) + "_softLeptonCheck.pdf")
